...
<body>
    ...
    <form method="POST" action="{{ route('sipalkom.store') }}">
        @csrf
        ...
        <label>Kondisi</label>
        <input type="text" name="kondisi" required value="{{ old('kondisi') }}"><br><br>
        ...
        <input type="date" name="tgl_peminjaman" required value="{{ old('tgl_peminjaman') }}"><br><br>

        <label>Tgl_kembali</label>
        <input type="date" name="tgl_kembali" required value="{{ old('tgl_kembali') }}"><br><br>
